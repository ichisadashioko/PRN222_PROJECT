...
public partial class AdventureWorksLt2014Context : DbContext
{
    public AdventureWorksLt2014Context()
    {
    }

    public AdventureWorksLt2014Context(DbContextOptions<AdventureWorksLt2014Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=ACER\\SQLEXPRESS;uid=sa;password=123456;database=AdventureWorksLT2014;Encrypt=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BuildVersion>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("BuildVersion", tb => tb.HasComment("Current version number of the AdventureWorksLT 2008 sample database. "));
